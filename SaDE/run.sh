...
then
    ...
    ./main.elf --N 10000 --D 30 --k 5000 --test_function 1 > result/Ackley/Ackley_30D.txt
elif [ "$1" == "Rastrigin" ] || [ "$1" == "2" ]
then 
    echo "Rastrigin"
    mkdir -p result/Rastrigin/
    ./main.elf --N 1000 --D 2 --k 500 --test_function 2  > result/Rastrigin/Rastrigin_2D.txt
    ./main.elf --N 1000 --D 10 --k 1000 --test_function 2 > result/Rastrigin/Rastrigin_10D.txt
    ./main.elf --N 10000 --D 30 --k 2000 --test_function 2 > result/Rastrigin/Rastrigin_30D.txt
elif [ "$1" == "HappyCat" ] || [ "$1" == "3" ]
then
    echo "HappyCat"
    mkdir -p result/HappyCat/
    ./main.elf --N 1000 --D 2 --k 500 --test_function 3  > result/HappyCat/HappyCat_2D.txt
    ./main.elf --N 1000 --D 10 --k 1000 --test_function 3 > result/HappyCat/HappyCat_10D.txt
    ./main.elf --N 1000 --D 30 --k 2000 --test_function 3 > result/HappyCat/HappyCat_30D.txt
...
then
    ...
    ./main.elf --N 1000 --D 10 --k 500 --test_function 4 > result/Rosenbrock/Rosenbrock_10D.txt
    ./main.elf --N 1000 --D 30 --k 2000 --test_function 4 > result/Rosenbrock/Rosenbrock_30D.txt
elif [ "$1" == "Zakharov" ] || [ "$1" == "5" ]
then
    echo "Zakharov"
    ...
    ./main.elf --N 1000 --D 30 --k 2000 --test_function 5 > result/Zakharov/Zakharov_30D.txt
...
then
    ...
    ./main.elf --N 1000 --D 30 --k 5000 --test_function 6 > result/Michalewicz/Michalewicz_30D.txt
elif [ "$1" == "Schwefel" ] || [ "$1" == "7" ]
then
    FN="Schwefel"
...
then
    ...
    ./main.elf --N 1000 --D 30 --k 9000 --test_function 8 > result/${FN}/${FN}_30D.txt
elif [ "$1" == "DropWave" ] || [ "$1" == "9" ]
then
    FN="DropWave"
    ...
    ./main.elf --N 1000 --D 10 --k 3000 --test_function 9 > result/${FN}/${FN}_10D.txt
    ./main.elf --N 1000 --D 30 --k 5000 --test_function 9 > result/${FN}/${FN}_30D.txt
elif [ "$1" == "Step" ] || [ "$1" == "10" ]
then
    FN="Step"
