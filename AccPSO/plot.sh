...
then
    echo "Ackley"
    mkdir -p plot/Ackley
    ./main.elf --N 1000 --D 2 --k 50 --alpha 0.2 --beta 0.8 --gamma 0.8 --L 2 --test_function 1  > /dev/null
    python plot.py 1
elif [ "$1" == "Rastrigin" ] || [ "$1" == "2" ]
then 
    echo "Rastrigin"
    mkdir -p plot/Rastrigin
    ./main.elf --N 1000 --D 2 --k 50 --alpha 0.2 --beta 0.8 --gamma 0.8 --L 2 --test_function 2  > /dev/null
    python plot.py 2
elif [ "$1" == "HappyCat" ] || [ "$1" == "3" ]
then
    echo "HappyCat"
    mkdir -p plot/HappyCat
    ./main.elf --N 1000 --D 2 --k 30 --alpha 0.2 --beta 0.8 --gamma 0.8 --L 2 --test_function 3  > /dev/null
    python plot.py 3
elif [ "$1" == "Rosenbrock" ] || [ "$1" == "4" ]
then
    echo "Rosenbrock"
    mkdir -p plot/Rosenbrock
    ./main.elf --N 1000 --D 2 --k 100 --alpha 0.2 --beta 0.8 --gamma 0.8 --L 2 --test_function 4  > /dev/null
    python plot.py 4
elif [ "$1" == "Zakharov" ] || [ "$1" == "5" ]
then
    echo "Zakharov"
    mkdir -p plot/Zakharov
    ./main.elf --N 1000 --D 2 --k 50 --alpha 0.2 --beta 0.5 --gamma 0.8 --L 2 --test_function 5  > /dev/null
    python plot.py 5
