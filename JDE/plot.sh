...
then
    ...
    echo ${FN}
    mkdir -p plot/${FN}
    ./main.elf --N 1000 --D 2 --k 100 --m 0.3 --c 0.5 --test_function 7  > /dev/null
    python plot.py 7
...
then
    ...
    echo ${FN}
    mkdir -p plot/${FN}
    ./main.elf --N 1000 --D 2 --k 100 --m 0.3 --c 0.5 --test_function 8  > /dev/null
    python plot.py 8
elif [ "$1" == "DropWave" ] || [ "$1" == "9" ]
then
    FN="DropWave"
    ...
    echo ${FN}
    mkdir -p plot/${FN}
    ./main.elf --N 1000 --D 2 --k 100 --m 0.3 --c 0.5 --test_function 9  > /dev/null
    python plot.py 9
elif [ "$1" == "Step" ] || [ "$1" == "10" ]
then
    FN="Step"
    ...
    echo ${FN}
    mkdir -p plot/${FN}
    ./main.elf --N 1000 --D 2 --k 100 --m 0.3 --c 0.5 --test_function 10  > /dev/null
    python plot.py 10
elif [ "$1" == "all" ] || [ "$1" == "-1" ]
then
    echo "Ackley"
