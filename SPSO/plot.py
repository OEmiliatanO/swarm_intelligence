...
plt.title('SPSO Particle Path')
plt.xlabel('X')
plt.ylabel('Y')
plt.grid(True)
print(f"save to plot/{func_str_table[fn]}/{func_str_table[fn]}_spso_plot.png")
plt.savefig(f'plot/{func_str_table[fn]}/{func_str_table[fn]}_spso_plot.png')
plt.close()
...
print(f"save to plot/{func_str_table[fn]}/{func_str_table[fn]}_spso_convergence.png")
plt.savefig(f'plot/{func_str_table[fn]}/{func_str_table[fn]}_spso_convergence.png')
plt.close()
...
print(f"save to plot/{func_str_table[fn]}/{func_str_table[fn]}_spso_path.gif")
ani.save(f'plot/{func_str_table[fn]}/{func_str_table[fn]}_spso_path.gif', writer=writer)
